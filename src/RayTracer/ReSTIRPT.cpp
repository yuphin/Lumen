...
void ReSTIRPT::render() {
	...
	// Trace rays
	instance->vkb.rg
		->add_rt("ReSTIRPT - Generate Samples", {.shaders = {{"src/shaders/integrators/restir/gris/restir.rgen"},
	...
	// Temporal reuse
	instance->vkb.rg
		->add_rt("ReSTIRPT - Temporal Reuse", {.shaders = {{"src/shaders/integrators/restir/gris/temporal_reuse.rgen"},
														   {"src/shaders/ray.rmiss"},
														   {"src/shaders/ray_shadow.rmiss"},
														   {"src/shaders/ray.rchit"},
														   {"src/shaders/ray.rahit"}},
	...
	// Spatial reuse
	instance->vkb.rg
		->add_rt("ReSTIRPT - Spatial Reuse", {.shaders = {{"src/shaders/integrators/restir/gris/spatial_reuse.rgen"},
														  {"src/shaders/ray.rmiss"},
														  {"src/shaders/ray_shadow.rmiss"},
														  {"src/shaders/ray.rchit"},
														  {"src/shaders/ray.rahit"}},
