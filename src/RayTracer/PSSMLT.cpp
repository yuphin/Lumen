...
void init(Integrator* integrator) {
	...
	SET_AND_REGISTER_BUFFER_ADDRESS(SceneDesc, desc, connection_primary_samples_addr, state.connection_primary_samples_buffer);
...
void render(Integrator* integrator) {
	...
	rg::add_rt(CSTR("PSSMLT - Bootstrap Sampling"),
				 {
