...
inline VkDebugUtilsMessengerCreateInfoEXT debug_messenger_CI(
...
inline VkDescriptorPoolCreateInfo descriptor_pool_CI(
	size_t poolSizeCount, VkDescriptorPoolSize* pPoolSizes, size_t maxSets) {
...
inline VkDescriptorPoolCreateInfo descriptor_pool_CI(
	const std::vector<VkDescriptorPoolSize>& poolSizes, size_t maxSets) {
	VkDescriptorPoolCreateInfo descriptorPoolInfo{};
	descriptorPoolInfo.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
...
inline VkPipelineTessellationStateCreateInfo pipeline_tesellation_state_CI(
...
inline VkSpecializationMapEntry specializaiton_map_entry(uint32_t constantID,
														 uint32_t offset,
														 size_t size) {
...
inline VkSpecializationInfo specialization_info(
	const std::vector<VkSpecializationMapEntry>& mapEntries, size_t dataSize,
	const void* data) {
...
inline VkPipelineStageFlags pipeline_stage_for_img_layout(
...
inline VkDependencyInfo dependency_info(
	int cnt, const VkBufferMemoryBarrier2* p_buffer_memory_barriers) {
...
inline VkDependencyInfo dependency_info(
	uint32_t cnt, const VkImageMemoryBarrier2* p_img_memory_barriers) {
	VkDependencyInfo res = {VK_STRUCTURE_TYPE_DEPENDENCY_INFO};
	res.dependencyFlags = 0;
...
inline VkRenderingAttachmentInfo rendering_attachment_info(
	VkImageLayout image_layout, VkAttachmentLoadOp load_op,
